        ...
        <div style={{ width: '100%', margin: '0 auto', maxWidth: 1300, marginTop: 64, zIndex: 4, position: 'relative' }}>
          ...
          <div style={{ display: 'flex', gap: '2.2rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <div style={{
              ...
              <img src="/images/3.jpeg" alt="AI for Student Assessments" style={{ width: '100%', height: 260, objectFit: 'cover', borderRadius: '1.5rem' }} />
            </div>
            <div style={{ maxWidth: 520, margin: '-18px 0 36px 0', textAlign: 'center', marginLeft: 'auto', marginRight: 'auto' }}>
              <div style={{ fontWeight: 800, fontSize: 24, marginBottom: 8, color: '#fff' }}>AI for Student Assessments</div>
              <div style={{ fontSize: 15, opacity: 0.93, marginBottom: 8, color: '#bcd1f7' }}>Rethinking How We Measure Learning</div>
            ...
            <div style={{
              ...
              <img src="/images/5.jpeg" alt="Predictive maintenance with AI" style={{ width: '100%', height: 260, objectFit: 'cover', borderRadius: '1.5rem' }} />
            </div>
            <div style={{ maxWidth: 520, margin: '-18px 0 36px 0', textAlign: 'center', marginLeft: 'auto', marginRight: 'auto' }}>
              <div style={{ fontWeight: 800, fontSize: 24, marginBottom: 8, color: '#fff' }}>Predictive maintenance with AI</div>
              <div style={{ fontSize: 15, opacity: 0.93, marginBottom: 8, color: '#bcd1f7' }}>Transforming Equipment Reliability in Manufacturing</div>
              <a href="#" style={{ color: '#60a5fa', fontWeight: 600, fontSize: 16, textDecoration: 'underline', marginTop: 4 }}>Read Blog</a>
            </div>
          </div>
        </div>
